...
extern "C"  Int32U5BU5D_t385246372* Regex_get_GroupNumbers_m2296197918 (Regex_t3657309853 * __this, const RuntimeMethod* method)
{
	...
	int32_t V_1 = 0;
	{
		Int32U5BU5D_t385246372* L_0 = __this->get_group_numbers_7();
		if (L_0)
		{
			goto IL_0076;
		}
	}
	{
		...
		__this->set_group_numbers_7(((Int32U5BU5D_t385246372*)SZArrayNew(Int32U5BU5D_t385246372_il2cpp_TypeInfo_var, (uint32_t)((int32_t)il2cpp_codegen_add((int32_t)1, (int32_t)L_1)))));
		V_0 = 0;
		goto IL_0032;
	}
...
IL_0025:
	{
		Int32U5BU5D_t385246372* L_2 = __this->get_group_numbers_7();
		int32_t L_3 = V_0;
		int32_t L_4 = V_0;
		NullCheck(L_2);
...
IL_004a:
	{
		Int32U5BU5D_t385246372* L_9 = __this->get_group_numbers_7();
		int32_t L_10 = V_1;
		StringU5BU5D_t1281789340* L_11 = __this->get_group_names_6();
		int32_t L_12 = V_1;
		NullCheck(L_11);
		int32_t L_13 = L_12;
...
IL_0063:
	...
	{
		Int32U5BU5D_t385246372* L_19 = __this->get_group_numbers_7();
		return L_19;
	}

IL_0076:
	{
		Int32U5BU5D_t385246372* L_20 = __this->get_group_numbers_7();
		return L_20;
	}
}
#ifdef __clang__
